...
public class UserDataProducer {
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        producer.send(purchaseRecord("shubham", "Computer (4)")).get();
        producer.send(userRecord("shubham", "First=shubham,Last=Tripathi,GitHub=shubhamTripathi")).get();
        producer.send(purchaseRecord("shubham", "Books (4)")).get();
        producer.send(userRecord("shubham", null)).get(); // delete for cleanup
